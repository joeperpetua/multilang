...
function TextInput(props) {
    return <div className="TextInput">
        ...
        <div className="text-input-buttons">
            <button className="clear-button" id="clear-button" onClick={() => props.clearText()}>Clear</button>
            <button className="translate-button" id="translate-button" onClick={() => props.runTranslation()}>Translate</button>
        </div>
